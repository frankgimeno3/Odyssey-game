...
export const SpanishQuestionnaire = ({ initialStage = "nombre" }: { initialStage?: string }) => {
  ...
  useEffect(() => {
    ...
    if (routeStage) window.history.replaceState(null, "", `/landing/es/${routeStage}`);
  }, [componenteactual]);
...
export default function SpanishQuestionnairePage() {
  return <SpanishQuestionnaire />;
}
