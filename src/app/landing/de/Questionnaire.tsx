...
export const GermanQuestionnaire = ({ initialStage = "nombre" }: { initialStage?: string }) => {
  ...
  useEffect(() => {
    ...
    if (routeStage) window.history.replaceState(null, "", `/landing/de/${routeStage}`);
  }, [componenteactual]);
...
export default function GermanQuestionnairePage() {
  return <GermanQuestionnaire />;
}
